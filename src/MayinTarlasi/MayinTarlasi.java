...
public class MayinTarlasi {
    public static int[][] RastgeleDoldur(int a, int b) {
        ...
        for (int k = 0; k < a; k++) {
            for (int l = 0; l < b; l++) {
                ...
                //System.out.print("*"+ " ");
                // ikinci sekilde yazdirirsaniz 1 ve 0 lari degil * lari gorursunuz ve gormeden oymamis olursunuz
            }
            System.out.println();
        }
    ...
    public static void main(String[] args) {
        ...
        for (int k = 0; k < oyunMatrisi.length; k++) {
            for (int l = 0; l < oyunMatrisi.length; l++) {
                System.out.print(oyunMatrisi[k][l] + " ");
            }
            System.out.println();
        }
